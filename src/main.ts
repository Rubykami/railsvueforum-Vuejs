...
import { faCaretDown, faChartSimple, faMessage, faMagnifyingGlass, faFile } from "@fortawesome/free-solid-svg-icons";
...
library.add(faCaretDown, faMagnifyingGlass, faChartSimple, faMessage, faFile);
